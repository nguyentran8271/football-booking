...
<div class="dashboard-container">
    <div class="container">
        ...
        <div class="quick-actions" style="display:grid; grid-template-columns: repeat(2, 1fr); gap:10px; margin-bottom:30px;">
            ...
            <a href="{{ route('owner.tournaments.index') }}" class="btn {{ request()->routeIs('owner.tournaments.*') ? 'btn-primary' : 'btn-secondary' }}" style="text-align:center; white-space:nowrap; height:42px; display:flex; align-items:center; justify-content:center;">Quản lý giải đấu</a>
        </div>
